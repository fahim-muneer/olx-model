...
function BackButton() {
  ...
  return (
    <div>
      <button 
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 mb-4 text-[#002f34] font-semibold hover:underline "
        >
        <svg fill="#000000" height="34px" width="34px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 219.151 219.151" xml:space="preserve" stroke="#000000" stroke-width="0.0021915100000000002">
